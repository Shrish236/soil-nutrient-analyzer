        ...
        <View style={{
            ...
            <Card
                ...
                >
                    ...
                    <Card.Title title="Admin Access" titleStyle={{
                        fontSize: 18,
                        textAlign: 'left',
                    ...
                    <Card.Content style={{
                       ...
                       <View style={{
                        ...
                        <Text style={{
                            ...
                            Admins can view enquiry details and soil health cards of the soil-testing enquiries submitted in their locality. Click enquiries to view more!
                         </Text>
                        </View>
                        <View style={{
                            width:'40%',
            ...
            <View style={{
                ...
                <FAB
                    ...
                    onPress={() => {
                        console.log('Pressed')
                        navigator.navigate("admin-enquiries")
                    }}
                    customSize={75}
                    color='black'
                />
